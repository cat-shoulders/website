const MolentjePrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">
          Privacy Policy - Molentje
        </h1>

        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
          <p>
            Cat Shoulder Devs built the Molentje app as an Ad Supported app.
            This SERVICE is provided by Cat Shoulder Devs at no cost and is
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Molentje unless
          ...
          <section className="mt-8">
            ...
            <p>
              ...
              <a
                href="mailto:hi@catshoulder.dev"
                className="text-blue-600 hover:text-blue-800 underline"
              >
                hi@catshoulder.dev
              </a>
...
export default MolentjePrivacyPolicy;
